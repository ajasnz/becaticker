...
def debug_rom_scanning():
    ...
    print("\n⚙️ Configuration:")
    print(
        f"  ROM directory from config: {config.get('second_display.arcade_mode.rom_directory', 'NOT SET')}"
    )
    print(
        f"  Arcade enabled: {config.get('second_display.arcade_mode.enabled', 'NOT SET')}"
    )

...
- Chain 1: 1x5 panels (320x64) for text display
...
Chain 2 uses U-mapper for proper 2x2 panel coordinate mapping.
Chaining order for 2x2: tl -> bl -> br -> tr
    ...
    def __init__(self, config_file: str = "config.json"):
        ...
        self.default_config = {
            ...
            "matrix_options": {
                ...
                "pixel_mapper_config": "U-mapper",  # For 2x2 panel arrangement on chain 2
            },
            "display_settings": {
...
class AnalogClock:
    ...
    def __init__(self, matrix: RGBMatrix, config: Config, row_offset: int = 64):
        ...
        # With U-mapper, the 2x2 arrangement should map to a logical 128x128 space
    ...
    def _set_pixel(self, x: int, y: int, color: graphics.Color) -> None:
        """Set a pixel on Chain 2 (2x2 panels) with U-mapper coordinate system."""
        # Apply row offset for Chain 2 and let U-mapper handle 2x2 panel layout
...
class BecaTicker:
    ...
    def __init__(self):
        ...
        # Initialize dual-chain matrix: Chain 1 (1x5) + Chain 2 (2x2)
        self.matrix = self._create_matrix()

        # Initialize displays for separate chains
    ...
    def _create_matrix(self) -> RGBMatrix:
        ...
        options.parallel = chain_config.get("parallel", 2)          # Chain 2: 2x2 panels
        ...
        # Set pixel mapper for Chain 2's 2x2 arrangement
        ...
        logger.info(
            f"Creating dual-chain matrix: Chain 1 (1x5 = 320x64), Chain 2 (2x2 = 128x128 with U-mapper)"
        )
    ...
    def _display_loop(self) -> None:
        """Main display update loop for dual-chain setup."""
        ...
        while self.running:
            try:
                ...
                # Chain 1: Text display (rows 0-63, 1x5 panels)
                self.text_display.update_display()

                # Chain 2: Analog clock display (rows 64+, 2x2 panels with U-mapper)

...
A 2x7 RGB LED matrix display system featuring:
- Text display area: Columns 0-4 (320x128) for scrolling text and calendar
- Clock display area: Columns 5-6 (128x128) for analog clock

Physical Layout (2x7 arrangement):
Row 1: [Text1][Text2][Text3][Text4][Text5][Clock-TL][Clock-TR]
Row 2: [Text1][Text2][Text3][Text4][Text5][Clock-BL][Clock-BR]

Total canvas: 448x128 pixels (7 columns × 2 rows of 64x64 panels)
The hzeller RGB matrix library handles the 2x7 coordinate mapping automatically.
    ...
    def __init__(self, config_file: str = "config.json"):
        ...
        self.default_config = {
            ...
            "matrix_options": {
                ...
                "pixel_mapper_config": "",  # Let library handle 2x7 mapping naturally
            },
            "display_settings": {
...
class AnalogClock:
    """Handles analog clock display in 2x2 section of 2x7 layout."""
    ...
    def _set_pixel(self, x: int, y: int, color: graphics.Color) -> None:
        """Set a pixel in the clock area of the 2x7 layout."""
...
class BecaTicker:
    ...
    def __init__(self):
        ...
        # Initialize 2x7 matrix layout: Text panels (cols 0-4) + Clock panels (cols 5-6)
        self.matrix = self._create_matrix()

        # Initialize displays for different sections of 2x7 layout
        # Text display: Uses columns 0-4 (320x128 total area)
    ...
    def _display_loop(self) -> None:
        """Main display update loop for 2x7 layout."""
        logger.info("Display update loop started - 2x7 layout mode")
